...
from models.gamification.parent_badge_notification import ParentBadgeNotification
from schemas.gamification.notification_schema import ParentBadgeNotificationDetail
