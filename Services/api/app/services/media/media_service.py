...
from models.media.avatar_tier_threshold import AvatarTier
from models.child.child_profile import ChildProfile
from models.user.user import User, UserRole
from schemas.media.media_schema import AvatarCreate, AvatarTierUpdateItem, AvatarUpdateRequest, AvatarUploadFormData
from services.media.media_cache_service import get_base_avatar_cache, get_cached_signed_url, invalidate_base_avatar_cache, invalidate_signed_url_cache
