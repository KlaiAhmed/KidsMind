...
from schemas.auth.auth_schema import UserRegister
from utils.auth.csrf import generate_csrf_token as build_csrf_token
from utils.auth.manage_pwd import hash_password, verify_password
