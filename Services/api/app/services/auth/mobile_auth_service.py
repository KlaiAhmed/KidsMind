...
from models.auth.refresh_token_session import RefreshTokenSession
from models.user.user import User
from schemas.auth.auth_schema import MobileRegisterRequest, UserLogin
from services.auth.attestation_service import AttestationService
...
from services.auth.login_flow import authenticate_user_with_challenge
...
class MobileAuthService:
    ...
    def get_user_id_by_email(self, email: str):
        ...
        return user.id if user else uuid4()
