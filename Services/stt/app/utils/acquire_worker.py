...
async def acquire_worker(request: Request):
    ...
    logger.info("Acquiring worker semaphore", extra={"current_available_workers": semaphore._value})
    ...
    try:
        ...
        semaphore.release()
        logger.info("Released worker semaphore", extra={"current_available_workers": semaphore._value})